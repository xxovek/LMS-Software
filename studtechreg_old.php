  ...
  <div class="content-wrapper">
    ...
    <section class="content"  id="StudentForm" style="display:none;">
      ...
      <section class="col-lg-2  connectedSortable">
        <button type="button" class="btn bg-purple margin" style="float:left" id="addstudent">New Register</button>
      </section>

      <div class="row" id="tabRow" >
      <div class="col-sm-12">

    <ul class="nav nav-tabs" role="tablist" id="st">
      <li role="presentation" id="ss" class="active"><a href="#studentactive" aria-controls="studentactive" role="tab" data-toggle="tab">Student</a></li>
      <li role="presentation" id="tt"><a href="#teacheractive" aria-controls="teacheractive" role="tab" data-toggle="tab">Teacher</a></li>
    </ul>

<div class="tab-content">
    <div id="studentactive" class="tab-pane active"  role="tabpanel">
        ...
        <div class="box-body table-responsive">
          <table id="studentinfotable"  class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <!-- <th class="text-center" style="width:5%">Roll No </th> -->
  ...
  <div id="teacheractive" class="tab-pane" role="tabpanel">
    <section class="content" id="teachertable">
      <div class="box" >
        <div class="box-header">
        ...
        <div class="box-body table-responsive">
          <table id="teacherinfotable"    class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <th class="text-center"  style="width:3%;">Teacher Id</th>
        ...
        for (var i = 0; i < count; i++)
         {
            ...
            $('#studenttabledata').append('<tr><td  class="text-center">'+(i + 1)+'</td><td class="text-center">' + response[i]['Studentid'] + '</td><td class="text-center"><button type="button" class="btn btn-link" data-toggle="collapse" title="Update Book Information" data-target="#demo" onclick="updatestudentinformation(' + student_id + ');">' + response[i]['FullName'] + '</button></td><td class="text-center">' + response[i]['MobileNumber'] + '</td><td class="text-center">'
             + response[i]['class1'] +'</td><td class="text-center" >'+ response[i]['address'] +'</td> <td class="text-center"><div class="btn-group"><button type="button" class="btn btn-success " data-toggle="collapse" title="Update Student Information" data-target="#hidecustomerfield" name="submit"  onclick="updatestudentinformation(' + student_id + ');"><i class="fa fa-edit"></i></button><button type="button" class="btn btn-danger" title="Remove Student" name="submit"  id="' + student_id + '" onClick="removestudent(' + student_id + ');" ><i class="fa fa-trash"></i></button></div></td></tr>');
